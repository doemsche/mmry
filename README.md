...
[![Build Status](https://travis-ci.org/doemsche/memory.svg?branch=master)](https://travis-ci.org/doemsche/memory) [![Dependency Status](https://david-dm.org/doemsche/memory.svg)](https://david-dm.org/doemsche/memory) [![devDependency Status](https://david-dm.org/doemsche/memory/dev-status.svg)](https://david-dm.org/doemsche/memory#info=devDependencies)
...
## Release History
 * 2014-07-17   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)